...
- [x] Removed v0.5.0 example file: components/structures/new-objects.csv
- [x] Removed v0.5.0 example file: components/texts/stories/story2/step8-layer1.md
- [x] Removed v0.5.0 example file: components/texts/stories/story2/step1-layer1-test.md
- [x] ℹ️  Kept 27 v0.5.0 example files (still referenced in Google Sheet)
- [x]   • components/images/ampl-logo.png
- [x]   • components/texts/stories/story2/step10-layer1.md
- [x]   • components/texts/stories/story2/step2-layer1.md
- [x]   • components/images/example-bogota-1614.png
- [x]   • components/images/codex-quetzalecatzin-1593.jpg
- [x]   ... and 22 more
- [x] ✓ Removed 3 v0.5.0 example files (not in use)
